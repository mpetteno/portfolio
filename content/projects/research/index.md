...
render = 'never'
+++
{{< projectTitle id="odyssey-2026-paper" title="Evaluating voice anonymisation using similarity rank disclosure"
title1="Paper" link1="https://www.isca-archive.org/odyssey_2026/chandra26_odyssey.html" icon1="fa-solid fa-newspaper"
detailsView="true">}}

<div class="project-details grid grid-rows-[0fr] transition-[grid-template-rows,opacity] duration-300 opacity-0">
  <div class="overflow-hidden">Traditional voice anonymisation evaluation relies heavily on EER, which provides an incomplete view of privacy risk. 
We introduce Similarity Rank Disclosure (SRD), a threshold-independent, information-theoretic metric that assesses 
privacy directly at the representation level. Applied to speaker embeddings, fundamental frequency, and phone 
representations from 2024 VoicePrivacy Challenge systems, SRD uncovers worst-case privacy leaks and system vulnerabilities
missed by standard EER metrics.</div>
</div>

{{< projectKeywords "voice anonymisation, privacy, evaluation" >}}
...
<div class="project-details grid grid-rows-[0fr] transition-[grid-template-rows,opacity] duration-300 opacity-0">
  <div class="overflow-hidden">Recent advances in latent diffusion models have demonstrated state-of-the-art performance in high-dimensional 
...
correlations between target and generated attributes while maintaining high perceptual quality and diversity.</div>
</div>
...
title2="Code" link2="https://github.com/mpetteno/box-cox-latent-reg" icon2="fa-brands fa-square-github" detailsView="true" >}}

<div class="project-details grid grid-rows-[0fr] transition-[grid-template-rows,opacity] duration-300 opacity-0">
  <div class="overflow-hidden">Explicit latent variable models provide a flexible yet powerful framework for data synthesis, enabling controlled 
...
title1="Code" link1="https://github.com/resolv-libs" icon1="fa-brands fa-square-github" detailsView="true" >}}

<div class="project-details grid grid-rows-[0fr] transition-[grid-template-rows,opacity] duration-300 opacity-0">
  <div class="overflow-hidden"> Resolv is a system designed to streamline machine learning and deep learning workflows for research purposes. The focus
...
experiment with new ides and techniques.</div>
</div>
...
<div class="project-details grid grid-rows-[0fr] transition-[grid-template-rows,opacity] duration-300 opacity-0">
  <div class="overflow-hidden">This study is focused on investigating the presence of any correlations between the topological structure of the latent 
...
the refining of post hoc conditioning in generative models.</div>
</div>
...
<div class="project-details grid grid-rows-[0fr] transition-[grid-template-rows,opacity] duration-300 opacity-0">
  <div class="overflow-hidden">The FONTI 4.0 project aims at exploring the suitability of automatic transcription and information extraction 
...
on the automatic transcription, showing what needs to be improved for implementing an unsupervised transcription chain.</div>
</div>
